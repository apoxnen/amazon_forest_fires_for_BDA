...
Since the Separate Negative binomal model has different values of alpha and beta for each state, the following analysis of convergence diagnostic is performed just for the first state, Acre.
```{r, echo=FALSE, tidy=FALSE,cache=FALSE, results='hyde', warning=FALSE, comment=FALSE, warning=FALSE, include=FALSE}
...
#alpha
matplot(Alpha[1:1000,1],type="line", col="black", xlab="Iteration", ylab="Alpha")
lines(Alpha[1001:2000,1], col="red")
lines(Alpha[2001:3000,1], col="orange")
lines(Alpha[3001:4000,1], col="blue")

matplot(Beta[1:1000,1],type="line", col="black", xlab="Iteration", ylab="Alpha")
