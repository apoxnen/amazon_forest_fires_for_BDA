---
title: "BDA - Negative binomial models"
author: "Anonymous"
output: 
  pdf_document: 
    toc: yes
...
generated quantities {
  ...
  for (i in 1:N) 
    log_lik[i] = neg_binomial_lpmf(y[i] | alpha[x[i]], beta);

  for (i in 1:K) 
    y_rep[i] = neg_binomial_rng(alpha[i], beta); 
}
"
####################################################################

hierarchical_negative_bin_2 = "
...
fit <- stan(
  model_code = hierarchical_negative_bin_2,  # Stan program
